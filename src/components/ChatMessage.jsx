...
import { childrenOfMessage } from '../hooks/useChat'
import { siblingInfo } from '../lib/chatTree'
...
export function ChatMessage(props) {
  const { message } = props
  // we use childrenOfMessage indirectly via siblingInfo; ensure tree util import path stays linked
  void childrenOfMessage
